  ...
  return (
    <div className="absolute inset-0 -z-10 bg-aurora animate-shimmer overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 30%, rgba(241,123,91,0.8), transparent 55%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 40% 40%, rgba(15,138,122,0.75), transparent 55%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 40% 40%, rgba(227,179,79,0.75), transparent 55%)",
        }}
